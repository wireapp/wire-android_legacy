...
class UserMapperTest : UnitTest() {
    ...
    companion object {
        ...
        private const val TEST_CONNECTION_TIMESTAMP = 1584462652.toLong()
        private const val TEST_CONNECTION_MESSAGE = "No Internet connection!"
        private const val TEST_CONVERSATION = "Hey guys"
        private const val TEST_TIMESTAMP = 1584462652.toLong()
        ...
        private const val TEST_EXPIRE_AT = 2215616275
