...
/**
 * Created by Wire Design Team on 22. Oct 2019.
...
public class WireStyleKit {
    ...
    private static class CacheForFolder {
        private static Paint paint = new Paint();
        private static RectF originalFrame = new RectF(0f, 0f, 64f, 64f);
        private static RectF resizedFrame = new RectF();
        private static RectF bezierRect = new RectF();
    ...
    public static void drawFolder(Canvas canvas, int color) {
        WireStyleKit.drawFolder(canvas, new RectF(0f, 0f, 64f, 64f), ResizingBehavior.AspectFit, color);
    }

    public static void drawFolder(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        // General Declarations
        Paint paint = CacheForFolder.paint;

        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForFolder.resizedFrame;
        WireStyleKit.resizingBehaviorApply(resizing, CacheForFolder.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 64f, resizedFrame.height() / 64f);

        // Bezier
        RectF bezierRect = CacheForFolder.bezierRect;
        bezierRect.set(0f, 0.55f, 64f, 60f);
        Path bezierPath = CacheForFolder.bezierPath;
        bezierPath.reset();
        bezierPath.moveTo(59.72f, 16.68f);
        bezierPath.cubicTo(58.04f, 16.68f, 20.8f, 16.6f, 19.48f, 16.6f);
        bezierPath.cubicTo(13.52f, 16.6f, 11.56f, 23.27f, 11.56f, 26.22f);
        bezierPath.cubicTo(11.52f, 26.46f, 8f, 55.13f, 8f, 55.13f);
        bezierPath.cubicTo(10.24f, 55.13f, 11.8f, 53.61f, 12f, 51.93f);
        bezierPath.cubicTo(13.72f, 39.56f, 13.72f, 38.64f, 14.8f, 29.86f);
        bezierPath.cubicTo(15.2f, 26.86f, 16.96f, 24.71f, 20f, 24.71f);
        bezierPath.cubicTo(34.76f, 24.71f, 44f, 24.71f, 58.76f, 24.71f);
        bezierPath.cubicTo(61.8f, 24.71f, 64.36f, 26.46f, 63.96f, 29.86f);
        bezierPath.cubicTo(62.68f, 38.4f, 61.88f, 43.79f, 61.04f, 50.1f);
        bezierPath.cubicTo(60.2f, 56.41f, 56.64f, 60f, 51.12f, 60f);
        bezierPath.cubicTo(35.4f, 60f, 23.24f, 60f, 7.52f, 60f);
        bezierPath.cubicTo(3.28f, 60.04f, 0f, 56.77f, 0f, 52.49f);
        bezierPath.cubicTo(0f, 36.88f, 0f, 21.27f, 0f, 5.62f);
        bezierPath.cubicTo(0f, 2.71f, 2.16f, 0.55f, 5.12f, 0.55f);
        bezierPath.cubicTo(11.12f, 0.55f, 11.76f, 0.55f, 17.76f, 0.55f);
        bezierPath.cubicTo(20.52f, 0.55f, 21.96f, 0.63f, 23.48f, 2.91f);
        bezierPath.cubicTo(24.64f, 4.58f, 24.12f, 3.86f, 25.2f, 5.46f);
        bezierPath.cubicTo(26.8f, 7.74f, 29.6f, 8.46f, 32.44f, 8.46f);
        bezierPath.cubicTo(36.72f, 8.46f, 50.48f, 8.46f, 54.76f, 8.46f);
        bezierPath.cubicTo(57.96f, 8.46f, 60.48f, 10.61f, 60.08f, 13.73f);
        bezierPath.cubicTo(60f, 14.4f, 59.84f, 16f, 59.72f, 16.68f);
        bezierPath.close();
    ...
    private static class CacheForConversationList {
        private static Paint paint = new Paint();
        private static RectF originalFrame = new RectF(0f, 0f, 64f, 64f);
        private static RectF resizedFrame = new RectF();
        private static RectF bezierRect = new RectF();
    ...
    public static void drawConversationList(Canvas canvas, int color) {
        WireStyleKit.drawConversationList(canvas, new RectF(0f, 0f, 64f, 64f), ResizingBehavior.AspectFit, color);
    }

    public static void drawConversationList(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        // General Declarations
        Paint paint = CacheForConversationList.paint;

        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForConversationList.resizedFrame;
        WireStyleKit.resizingBehaviorApply(resizing, CacheForConversationList.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 64f, resizedFrame.height() / 64f);
        ...
        {
            // Bezier
            RectF bezierRect = CacheForConversationList.bezierRect;
            bezierRect.set(0f, 28.02f, 64f, 36.08f);
            Path bezierPath = CacheForConversationList.bezierPath;
            bezierPath.reset();
            bezierPath.moveTo(59.88f, 36.08f);
            bezierPath.lineTo(4.12f, 36.08f);
            bezierPath.cubicTo(1.84f, 36.08f, 0f, 34.28f, 0f, 32.05f);
            bezierPath.cubicTo(0f, 29.82f, 1.84f, 28.02f, 4.12f, 28.02f);
            bezierPath.lineTo(59.88f, 28.02f);
            bezierPath.cubicTo(62.16f, 28.02f, 64f, 29.82f, 64f, 32.05f);
            bezierPath.cubicTo(64f, 34.28f, 62.16f, 36.08f, 59.88f, 36.08f);
            bezierPath.close();
        ...
        {
            // Bezier 2
            RectF bezier2Rect = CacheForConversationList.bezier2Rect;
            bezier2Rect.set(0f, 11.9f, 64f, 19.96f);
            Path bezier2Path = CacheForConversationList.bezier2Path;
            bezier2Path.reset();
            bezier2Path.moveTo(59.88f, 19.96f);
            bezier2Path.lineTo(4.12f, 19.96f);
            bezier2Path.cubicTo(1.84f, 19.96f, 0f, 18.16f, 0f, 15.93f);
            bezier2Path.cubicTo(0f, 13.7f, 1.84f, 11.9f, 4.12f, 11.9f);
            bezier2Path.lineTo(59.88f, 11.9f);
            bezier2Path.cubicTo(62.16f, 11.9f, 64f, 13.7f, 64f, 15.93f);
            bezier2Path.cubicTo(64f, 18.16f, 62.16f, 19.96f, 59.88f, 19.96f);
            bezier2Path.close();
        ...
        {
            // Bezier 3
            RectF bezier3Rect = CacheForConversationList.bezier3Rect;
            bezier3Rect.set(0f, 45.24f, 43.85f, 53.3f);
            Path bezier3Path = CacheForConversationList.bezier3Path;
            bezier3Path.reset();
            bezier3Path.moveTo(39.69f, 53.3f);
            bezier3Path.lineTo(4.16f, 53.3f);
            bezier3Path.cubicTo(1.86f, 53.3f, 0f, 51.5f, 0f, 49.27f);
            bezier3Path.cubicTo(0f, 47.04f, 1.86f, 45.24f, 4.16f, 45.24f);
            bezier3Path.lineTo(39.69f, 45.24f);
            bezier3Path.cubicTo(41.99f, 45.24f, 43.85f, 47.04f, 43.85f, 49.27f);
            bezier3Path.cubicTo(43.85f, 51.5f, 41.99f, 53.3f, 39.69f, 53.3f);
            bezier3Path.close();
    ...
    private static class CacheForFavoritesOff {
        private static Paint paint = new Paint();
        private static RectF originalFrame = new RectF(0f, 0f, 64f, 64f);
        private static RectF resizedFrame = new RectF();
        private static RectF bezierRect = new RectF();
    ...
    public static void drawFavoritesOff(Canvas canvas, int color) {
        WireStyleKit.drawFavoritesOff(canvas, new RectF(0f, 0f, 64f, 64f), ResizingBehavior.AspectFit, color);
    }

    public static void drawFavoritesOff(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        // General Declarations
        Paint paint = CacheForFavoritesOff.paint;

        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForFavoritesOff.resizedFrame;
        WireStyleKit.resizingBehaviorApply(resizing, CacheForFavoritesOff.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 64f, resizedFrame.height() / 64f);

        // Bezier
        RectF bezierRect = CacheForFavoritesOff.bezierRect;
        bezierRect.set(-0.01f, 0.01f, 64f, 64f);
        Path bezierPath = CacheForFavoritesOff.bezierPath;
        bezierPath.reset();
        bezierPath.moveTo(63.22f, 27.04f);
        bezierPath.lineTo(49.05f, 40.91f);
        bezierPath.lineTo(52.61f, 60.32f);
        bezierPath.cubicTo(52.89f, 61.02f, 52.87f, 61.84f, 52.49f, 62.56f);
        bezierPath.cubicTo(51.84f, 63.8f, 50.35f, 64.24f, 49.18f, 63.55f);
        bezierPath.lineTo(32.19f, 53.61f);
        bezierPath.lineTo(14.88f, 63.68f);
        bezierPath.cubicTo(13.7f, 64.36f, 12.22f, 63.92f, 11.57f, 62.67f);
        bezierPath.cubicTo(11.21f, 61.99f, 11.18f, 61.2f, 11.43f, 60.52f);
        bezierPath.lineTo(15.05f, 41.02f);
        bezierPath.lineTo(0.81f, 27f);
        bezierPath.cubicTo(0.41f, 26.61f, 0.17f, 26.12f, 0.08f, 25.59f);
        bezierPath.cubicTo(0.05f, 25.47f, 0.02f, 25.34f, 0f, 25.21f);
        bezierPath.cubicTo(-0.16f, 23.8f, 0.79f, 22.52f, 2.13f, 22.35f);
        bezierPath.lineTo(21.47f, 19.88f);
        bezierPath.lineTo(29.65f, 1.48f);
        bezierPath.cubicTo(30.22f, 0.2f, 31.67f, -0.35f, 32.89f, 0.25f);
        bezierPath.cubicTo(33.13f, 0.37f, 33.34f, 0.52f, 33.52f, 0.7f);
        bezierPath.cubicTo(33.78f, 0.93f, 34f, 1.22f, 34.15f, 1.57f);
        bezierPath.lineTo(42.33f, 20.08f);
        bezierPath.lineTo(61.54f, 22.59f);
        bezierPath.cubicTo(62.2f, 22.59f, 62.86f, 22.86f, 63.35f, 23.41f);
        bezierPath.cubicTo(64.26f, 24.45f, 64.21f, 26.07f, 63.22f, 27.04f);
        bezierPath.close();
        bezierPath.moveTo(40.61f, 25.03f);
        bezierPath.cubicTo(40.42f, 25f, 40.24f, 24.95f, 40.06f, 24.88f);
        bezierPath.cubicTo(39.38f, 24.7f, 38.77f, 24.21f, 38.45f, 23.48f);
        bezierPath.lineTo(31.87f, 8.59f);
        bezierPath.lineTo(25.3f, 23.38f);
        bezierPath.cubicTo(24.87f, 24.34f, 23.94f, 24.89f, 22.99f, 24.85f);
        bezierPath.lineTo(7.74f, 26.8f);
        bezierPath.lineTo(18.88f, 37.76f);
        bezierPath.cubicTo(19.8f, 38.28f, 20.33f, 39.38f, 20.12f, 40.51f);
        bezierPath.lineTo(17.14f, 56.5f);
        bezierPath.lineTo(30.63f, 48.66f);
        bezierPath.cubicTo(30.81f, 48.55f, 31.01f, 48.48f, 31.2f, 48.42f);
        bezierPath.cubicTo(31.9f, 48.07f, 32.73f, 48.06f, 33.46f, 48.49f);
        bezierPath.lineTo(46.92f, 56.36f);
        bezierPath.lineTo(43.98f, 40.31f);
        bezierPath.cubicTo(43.76f, 39.12f, 44.37f, 37.96f, 45.39f, 37.48f);
        bezierPath.lineTo(56.05f, 27.05f);
        bezierPath.lineTo(40.61f, 25.03f);
        bezierPath.close();
    ...
    private static class CacheForFavoritesOn {
        private static Paint paint = new Paint();
        private static RectF originalFrame = new RectF(0f, 0f, 64f, 64f);
        private static RectF resizedFrame = new RectF();
        private static RectF bezierRect = new RectF();
    ...
    public static void drawFavoritesOn(Canvas canvas, int color) {
        WireStyleKit.drawFavoritesOn(canvas, new RectF(0f, 0f, 64f, 64f), ResizingBehavior.AspectFit, color);
    }

    public static void drawFavoritesOn(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        // General Declarations
        Paint paint = CacheForFavoritesOn.paint;

        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForFavoritesOn.resizedFrame;
        WireStyleKit.resizingBehaviorApply(resizing, CacheForFavoritesOn.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 64f, resizedFrame.height() / 64f);

        // Bezier
        RectF bezierRect = CacheForFavoritesOn.bezierRect;
        bezierRect.set(0.99f, 0.01f, 63f, 64f);
        Path bezierPath = CacheForFavoritesOn.bezierPath;
        bezierPath.reset();
        bezierPath.moveTo(62.25f, 27.04f);
        bezierPath.lineTo(48.52f, 40.91f);
        bezierPath.lineTo(51.97f, 60.32f);
        bezierPath.cubicTo(52.24f, 61.02f, 52.22f, 61.84f, 51.85f, 62.56f);
        bezierPath.cubicTo(51.22f, 63.8f, 49.78f, 64.24f, 48.64f, 63.55f);
        bezierPath.lineTo(32.18f, 53.61f);
        bezierPath.lineTo(15.42f, 63.68f);
        bezierPath.cubicTo(14.27f, 64.36f, 12.84f, 63.92f, 12.21f, 62.67f);
        bezierPath.cubicTo(11.86f, 61.99f, 11.83f, 61.2f, 12.07f, 60.52f);
        bezierPath.lineTo(15.58f, 41.02f);
        bezierPath.lineTo(1.78f, 27f);
        bezierPath.cubicTo(1.4f, 26.61f, 1.17f, 26.12f, 1.08f, 25.59f);
        bezierPath.cubicTo(1.05f, 25.47f, 1.02f, 25.34f, 1f, 25.21f);
        bezierPath.cubicTo(0.85f, 23.8f, 1.77f, 22.52f, 3.06f, 22.35f);
        bezierPath.lineTo(21.8f, 19.88f);
        bezierPath.lineTo(29.72f, 1.48f);
        bezierPath.cubicTo(30.27f, 0.2f, 31.68f, -0.35f, 32.86f, 0.25f);
        bezierPath.cubicTo(33.09f, 0.37f, 33.3f, 0.52f, 33.47f, 0.7f);
        bezierPath.cubicTo(33.72f, 0.93f, 33.94f, 1.22f, 34.08f, 1.57f);
        bezierPath.lineTo(42.01f, 20.08f);
        bezierPath.lineTo(60.62f, 22.59f);
        bezierPath.cubicTo(61.26f, 22.59f, 61.9f, 22.86f, 62.37f, 23.41f);
        bezierPath.cubicTo(63.26f, 24.45f, 63.2f, 26.07f, 62.25f, 27.04f);
        bezierPath.close();
    ...
    private static class CacheForMoveTo {
        private static Paint paint = new Paint();
        private static RectF originalFrame = new RectF(0f, 0f, 64f, 64f);
        private static RectF resizedFrame = new RectF();
        private static RectF bezierRect = new RectF();
    ...
    public static void drawMoveTo(Canvas canvas, int color) {
        WireStyleKit.drawMoveTo(canvas, new RectF(0f, 0f, 64f, 64f), ResizingBehavior.AspectFit, color);
    }

    public static void drawMoveTo(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        // General Declarations
        Paint paint = CacheForMoveTo.paint;

        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForMoveTo.resizedFrame;
        WireStyleKit.resizingBehaviorApply(resizing, CacheForMoveTo.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 64f, resizedFrame.height() / 64f);

        // Bezier
        RectF bezierRect = CacheForMoveTo.bezierRect;
        bezierRect.set(0f, 0f, 64f, 64f);
        Path bezierPath = CacheForMoveTo.bezierPath;
        bezierPath.reset();
        bezierPath.moveTo(63.25f, 33.55f);
        bezierPath.lineTo(33.54f, 63.25f);
        bezierPath.cubicTo(32.66f, 64.13f, 31.36f, 64.25f, 30.64f, 63.53f);
        bezierPath.lineTo(30.59f, 48.57f);
        bezierPath.cubicTo(30.58f, 48.57f, 30.56f, 48.57f, 30.54f, 48.57f);
        bezierPath.lineTo(1.61f, 48.57f);
        bezierPath.cubicTo(0.72f, 48.57f, 0f, 47.85f, 0f, 46.96f);
        bezierPath.lineTo(0f, 16.97f);
        bezierPath.cubicTo(0f, 16.08f, 0.72f, 15.36f, 1.61f, 15.36f);
        bezierPath.lineTo(30.48f, 15.36f);
        bezierPath.lineTo(30.43f, 0.75f);
        bezierPath.cubicTo(31.31f, -0.13f, 32.61f, -0.25f, 33.33f, 0.47f);
        bezierPath.lineTo(63.53f, 30.66f);
        bezierPath.cubicTo(64.25f, 31.38f, 64.13f, 32.68f, 63.25f, 33.55f);
        bezierPath.close();
    ...
    private static class CacheForRemoveFrom {
        private static Paint paint = new Paint();
        private static RectF originalFrame = new RectF(0f, 0f, 64f, 64f);
        private static RectF resizedFrame = new RectF();
        private static RectF bezierRect = new RectF();
    ...
    public static void drawRemoveFrom(Canvas canvas, int color) {
        WireStyleKit.drawRemoveFrom(canvas, new RectF(0f, 0f, 64f, 64f), ResizingBehavior.AspectFit, color);
    }

    public static void drawRemoveFrom(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        // General Declarations
        Paint paint = CacheForRemoveFrom.paint;

        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForRemoveFrom.resizedFrame;
        WireStyleKit.resizingBehaviorApply(resizing, CacheForRemoveFrom.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 64f, resizedFrame.height() / 64f);

        // Bezier
        RectF bezierRect = CacheForRemoveFrom.bezierRect;
        bezierRect.set(0f, 0f, 64f, 64f);
        Path bezierPath = CacheForRemoveFrom.bezierPath;
        bezierPath.reset();
        bezierPath.moveTo(62.39f, 48.57f);
        bezierPath.lineTo(33.46f, 48.57f);
        bezierPath.cubicTo(33.44f, 48.57f, 33.42f, 48.57f, 33.41f, 48.57f);
        bezierPath.lineTo(33.36f, 63.53f);
        bezierPath.cubicTo(32.64f, 64.25f, 31.34f, 64.13f, 30.46f, 63.25f);
        bezierPath.lineTo(0.75f, 33.55f);
        bezierPath.cubicTo(-0.13f, 32.68f, -0.25f, 31.38f, 0.47f, 30.66f);
        bezierPath.lineTo(30.67f, 0.47f);
        bezierPath.cubicTo(31.39f, -0.25f, 32.69f, -0.13f, 33.57f, 0.75f);
        bezierPath.lineTo(33.52f, 15.36f);
        bezierPath.lineTo(62.39f, 15.36f);
        bezierPath.cubicTo(63.28f, 15.36f, 64f, 16.08f, 64f, 16.97f);
        bezierPath.lineTo(64f, 46.96f);
        bezierPath.cubicTo(64f, 47.85f, 63.28f, 48.57f, 62.39f, 48.57f);
        bezierPath.close();
    ...
    private static class CacheForContacts {
        private static Paint paint = new Paint();
        private static RectF originalFrame = new RectF(0f, 0f, 64f, 64f);
        private static RectF resizedFrame = new RectF();
    ...
    public static void drawContacts(Canvas canvas, int color) {
        WireStyleKit.drawContacts(canvas, new RectF(0f, 0f, 64f, 64f), ResizingBehavior.AspectFit, color);
    }

    public static void drawContacts(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        // General Declarations
        Paint paint = CacheForContacts.paint;

        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForContacts.resizedFrame;
        WireStyleKit.resizingBehaviorApply(resizing, CacheForContacts.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 64f, resizedFrame.height() / 64f);

        // path-1
        RectF path1Rect = CacheForContacts.path1Rect;
        path1Rect.set(4f, 0f, 60f, 64f);
        Path path1Path = CacheForContacts.path1Path;
        path1Path.reset();
        path1Path.moveTo(46.43f, 40f);
        path1Path.lineTo(47.99f, 40f);
        path1Path.cubicTo(54.62f, 40f, 60f, 45.39f, 60f, 52f);
        path1Path.lineTo(60f, 57.08f);
        path1Path.lineTo(60f, 57.08f);
        path1Path.cubicTo(51.64f, 61.5f, 42.11f, 64f, 32f, 64f);
        path1Path.cubicTo(21.89f, 64f, 12.36f, 61.5f, 4f, 57.08f);
        path1Path.lineTo(4f, 52f);
        path1Path.cubicTo(4f, 45.37f, 9.37f, 40f, 16.01f, 40f);
        path1Path.lineTo(17.57f, 40f);
        path1Path.cubicTo(21.78f, 42.54f, 26.72f, 44f, 32f, 44f);
        path1Path.cubicTo(37.28f, 44f, 42.22f, 42.54f, 46.43f, 40f);
        path1Path.lineTo(46.43f, 40f);
        path1Path.lineTo(46.43f, 40f);
        path1Path.close();
        path1Path.moveTo(32f, 32f);
        path1Path.cubicTo(40.84f, 32f, 48f, 24.84f, 48f, 16f);
        path1Path.cubicTo(48f, 7.16f, 40.84f, 0f, 32f, 0f);
        path1Path.cubicTo(23.16f, 0f, 16f, 7.16f, 16f, 16f);
        path1Path.cubicTo(16f, 24.84f, 23.16f, 32f, 32f, 32f);
        path1Path.lineTo(32f, 32f);
        path1Path.close();

        paint.reset();
        paint.setFlags(Paint.ANTI_ALIAS_FLAG);
        path1Path.setFillType(Path.FillType.EVEN_ODD);
        paint.setStyle(Paint.Style.FILL);
        paint.setColor(color);
        canvas.drawPath(path1Path, paint);

        canvas.restore();
    }

    private static class CacheForEraser {
        private static Paint paint = new Paint();
        private static RectF originalFrame = new RectF(0f, 0f, 64f, 64f);
        private static RectF resizedFrame = new RectF();
        private static RectF bezierRect = new RectF();
    ...
    public static void drawEraser(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int color) {
        ...
        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForEraser.resizedFrame;
        WireStyleKit.resizingBehaviorApply(resizing, CacheForEraser.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 64f, resizedFrame.height() / 64f);

        // Bezier
        RectF bezierRect = CacheForEraser.bezierRect;
        bezierRect.set(0f, 1.1f, 64f, 64f);
        Path bezierPath = CacheForEraser.bezierPath;
        bezierPath.reset();
        bezierPath.moveTo(59.23f, 47.28f);
        bezierPath.lineTo(41.34f, 47.28f);
        bezierPath.lineTo(61.61f, 26.98f);
        bezierPath.cubicTo(64.8f, 23.79f, 64.8f, 19.01f, 61.61f, 15.83f);
        bezierPath.lineTo(49.29f, 3.49f);
        bezierPath.lineTo(49.33f, 3.53f);
        bezierPath.cubicTo(47.87f, 2.01f, 45.86f, 1.14f, 43.75f, 1.1f);
        bezierPath.lineTo(43.7f, 1.1f);
        bezierPath.cubicTo(41.59f, 1.14f, 39.59f, 2.01f, 38.12f, 3.53f);
        bezierPath.lineTo(11.53f, 30.16f);
        bezierPath.lineTo(11.6f, 30.09f);
        bezierPath.cubicTo(7.17f, 34.53f, 6.92f, 41.64f, 11.03f, 46.37f);
        bezierPath.lineTo(17.49f, 53.25f);
        bezierPath.lineTo(58.83f, 53.25f);
        bezierPath.cubicTo(60.42f, 53.25f, 61.61f, 52.06f, 61.61f, 50.46f);
        bezierPath.cubicTo(62.01f, 48.47f, 60.82f, 47.28f, 59.23f, 47.28f);
        bezierPath.close();
        bezierPath.moveTo(15.9f, 34.54f);
        bezierPath.lineTo(22.66f, 27.77f);
        bezierPath.lineTo(37.37f, 42.5f);
        bezierPath.lineTo(32.99f, 47.28f);
        bezierPath.lineTo(20.27f, 47.28f);
        bezierPath.lineTo(15.9f, 42.1f);
        bezierPath.cubicTo(13.52f, 40.11f, 13.91f, 36.53f, 15.9f, 34.54f);
        bezierPath.close();
        bezierPath.moveTo(9.14f, 50.07f);
        bezierPath.cubicTo(9.14f, 48.47f, 7.95f, 47.28f, 6.36f, 47.28f);
        bezierPath.lineTo(2.78f, 47.28f);
        bezierPath.cubicTo(1.19f, 47.28f, 0f, 48.47f, 0f, 50.07f);
        bezierPath.cubicTo(0f, 51.66f, 1.19f, 52.85f, 2.78f, 52.85f);
        bezierPath.lineTo(5.96f, 52.85f);
        bezierPath.cubicTo(7.95f, 53.25f, 9.14f, 51.66f, 9.14f, 50.07f);
        bezierPath.close();
        bezierPath.moveTo(11.13f, 56.83f);
        bezierPath.lineTo(8.75f, 59.22f);
        bezierPath.cubicTo(7.55f, 60.42f, 7.55f, 62.41f, 8.75f, 63.2f);
        bezierPath.cubicTo(9.14f, 64f, 9.94f, 64f, 10.73f, 64f);
        bezierPath.lineTo(12.72f, 63.2f);
        bezierPath.lineTo(15.11f, 60.82f);
        bezierPath.cubicTo(16.3f, 59.62f, 16.3f, 57.63f, 15.11f, 56.83f);
        bezierPath.cubicTo(14.31f, 55.64f, 12.32f, 55.64f, 11.13f, 56.83f);
        bezierPath.close();
