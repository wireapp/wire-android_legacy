...
class ConversationsLocalDataSource(private val conversationsDao: ConversationsDao):
    BackupLocalDataSource<ConversationsEntity, ConversationsJSONEntity>(ConversationsJSONEntity.serializer()) {
    ...
    override fun toJSONType(entity: ConversationsEntity): ConversationsJSONEntity = ConversationsJSONEntity.from(entity)
    override fun toEntityType(json: ConversationsJSONEntity): ConversationsEntity = json.toEntity()
}
