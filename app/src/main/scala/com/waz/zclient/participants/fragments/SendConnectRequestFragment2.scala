...
class SendConnectRequestFragment2 extends SingleParticipantFragment with DerivedLogTag {
  ...
  override def onBackPressed(): Boolean = {
    ...
    } else navigationController.setLeftPage(returnPage, SendConnectRequestFragment2.Tag)
    true
  }
}
