...
object BackgroundRequest {
  ...
  def apply(assetId: AssetIdGeneral)(implicit context: Context): RequestBuilder[Drawable] = {
    ...
    GlideBuilder.apply(assetId).apply(opt).transition(DrawableTransitionOptions.withCrossFade())
  }
}
