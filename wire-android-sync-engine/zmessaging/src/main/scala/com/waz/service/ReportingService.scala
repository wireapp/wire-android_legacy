...
trait ReportingService {
  ...
  private implicit val dispatcher: DispatchQueue = SerialDispatchQueue(name = "ReportingService")
...
class ZmsReportingService(user: UserId, global: ReportingService) extends ReportingService {
  private implicit val dispatcher: DispatchQueue = SerialDispatchQueue(name = "ZmsReportingService")
