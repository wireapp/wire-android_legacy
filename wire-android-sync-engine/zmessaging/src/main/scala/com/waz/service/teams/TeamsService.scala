...
import com.wire.signals.{AggregatingSignal, CancellableFuture, DispatchQueue, EventStream, RefreshingSignal, SerialDispatchQueue, Signal}
...
class TeamsServiceImpl(selfUser:           UserId,
  ...
  private implicit val dispatcher: DispatchQueue = SerialDispatchQueue(name = "TeamsService")
