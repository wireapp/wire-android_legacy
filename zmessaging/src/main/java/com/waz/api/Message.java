...
public interface Message extends UiObservable {
    ...
    enum Type { //TODO BUTTONS: add new message types here
        ...
        MEMBER_LEAVE, MEMBER_LEAVE_DUE_TO_LEGAL_HOLD, CONNECT_REQUEST, CONNECT_ACCEPTED, RENAME,

        MISSED_CALL, SUCCESSFUL_CALL,

        OTR_ERROR, OTR_ERROR_FIXED, OTR_IDENTITY_CHANGED, OTR_VERIFIED, OTR_UNVERIFIED, OTR_DEVICE_ADDED, OTR_MEMBER_ADDED,

        LEGALHOLD_ENABLED, LEGALHOLD_DISABLED,
    ...
    interface Part {
        enum Type {
            TEXT, TEXT_EMOJI_ONLY, ASSET, ANY_ASSET, YOUTUBE, SOUNDCLOUD, TWITTER, SPOTIFY, WEB_LINK, MAPS
        }
    }
}
