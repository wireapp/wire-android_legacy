...
public enum ErrorType {
    ...
    CANNOT_SEND_MESSAGE_TO_UNAPPROVED_LEGAL_HOLD_CONVERSATION,
    CANNOT_ADD_PARTICIPANT_WITH_MISSING_LEGAL_HOLD_CONSENT,
    CANNOT_CREATE_GROUP_CONVERSATION_WITH_USER_MISSING_LEGAL_HOLD_CONSENT,
    CANNOT_CONNECT_USER_WITH_MISSING_LEGAL_HOLD_CONSENT
}
