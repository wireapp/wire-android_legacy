...
object Config {
  ...
  val AuthenticationManager: AuthenticationManager2 = {
  ...
  implicit val authRequestInterceptor: AuthRequestInterceptor2 = new AuthRequestInterceptor2(AuthenticationManager, HttpClient)
