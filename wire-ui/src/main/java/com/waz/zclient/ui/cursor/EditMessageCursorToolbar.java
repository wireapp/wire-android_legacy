...
public class EditMessageCursorToolbar extends FrameLayout implements View.OnClickListener {
    ...
    private void init() {
        ...
        enabledTextColor = ContextCompat.getColor(getContext(), R.color.drawing__icon__enabled_color);
        disabledTextColor = ContextCompat.getColor(getContext(), R.color.drawing__icon__disabled_color);
